...
from Payroll import get_policy, LTDPolicy
from Contact import get_employee_address
...
class Employee(AsDictionaryMixin):
    ...
    def __init__(self, id):
        self.id = id
        info = employee_database.get_emp_info(self.id)
...
"""You first import the relevant functions and classes from other modules. The _EmployeeDatabase is made internal, 
and at the bottom, you create a single instance. This instance is public and part of the interface because you will 
want to use it in the application. 

You changed the _EmployeeDatabase._employees attribute to be a dictionary where the key is the employee id and the 
value is the employee information. You also exposed a .get_employee_info() method to return the information for the 
specified employee employee_id. 
